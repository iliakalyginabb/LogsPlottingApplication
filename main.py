...
def update_visibility():
    global df_signals, plot_settings

    # dictionary to map plot ids to plots
    plots = {'plot1': plot1, 'plot2': plot2, 'plot3': plot3, 'plot4': plot4}

    for idx, row in df_signals.iterrows():  # unpack the tuple into index and row
...
def show_results():
    global df_global, plot1, plot2, plot3, plot4
            ...
            with ui.tab_panel(signals_table):
                ...
                def on_grid_value_change(event):
                    ...
                    if not df_signals[mask].empty:
                        ...
                        df_signals.loc[mask, 'sync_x_axis'] = data['sync_x_axis']
